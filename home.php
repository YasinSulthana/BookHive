...
<body>
	...
	<main>
		...
		<section id="featured-books">
			...
			<div class="filters">
				...
				<select id="price" onchange="applyFilters()">
					...
					<option value="lt_15">Less than ₹300</option>
					<option value="gt_15">Greater than ₹300</option>
				</select>
			</div>
			<ul id="book-list">
				<?php
		...
		<div class='signature' style='background-color:white;margin-left:800px;font-size:20px'>Designed by Yasin Sulthana</div>
		<!-- <section class='signature'>YASEEN SULTHANA</section> -->
		<script>
